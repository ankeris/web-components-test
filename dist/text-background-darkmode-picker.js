...
.box2:before{
  ...
  position:absolute;
        ...
        this.shadowRoot.querySelector('#toggle').addEventListener('click', () => {
            var _a, _b;
            ((_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('#blender')).classList.toggle('expand');
            ((_b = this.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector('#toggle')).classList.toggle('ZIndex-checker');
        });
        if (screen.width >= 768) {
            this.shadowRoot.querySelector('#toggle').addEventListener('mouseenter', () => {
                var _a, _b;
                ((_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('#blender')).classList.add('expand-hover');
                ((_b = this.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector('#toggle')).classList.add('ZIndex-checker');
            });
            this.shadowRoot.querySelector('#toggle').addEventListener('mouseout', () => {
                var _a, _b;
                ((_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('#blender')).classList.remove('expand-hover');
                ((_b = this.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector('#toggle')).classList.remove('ZIndex-checker');
            });
        }
